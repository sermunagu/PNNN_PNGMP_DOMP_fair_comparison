...
expectedModels = sort(["Complex GMP DOMP sweep"; "Independent PN-IQ PN-DOMP sweep"; "Sparse PNNN N12"]);
...
if width(results) ~= 13 || width(fixedResults) ~= 8 || ...
    ...
    error('run_parameter_sweep:CoefficientRangeContract', ...
        ['The schema-v4 principal/fixed tables must contain 13/8 columns ' ...
