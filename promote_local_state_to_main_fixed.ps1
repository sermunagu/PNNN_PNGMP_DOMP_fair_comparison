...
# Fuerza UTF-8 para la comunicación con ejecutables nativos como git.exe.
...
# No reutilizamos la ruta impresa por git porque Git for Windows puede
# devolver caracteres UTF-8 que algunas configuraciones de consola interpretan
# con la página de códigos OEM. La ubicación actual ya ha sido validada como repo.
